...
/// Tactical Minimalist Design - Dark Mode Focus
class AppColors {
  ...
  // Dark Mode Backgrounds - Custom OKLch Palette
  static const Color darkBackgroundDeep = Color(0xFF1a1621); // Darkest (oklch(12.9% 0.042 264.695))
  static const Color darkBackgroundMid = Color(0xFF2a2234); // Darker (oklch(20.8% 0.042 265.755))
  static const Color darkBackgroundElevated = Color(0xFF3a3047); // Lightest (oklch(27.9% 0.041 260.031))
  ...
  // ===== LIGHT MODE COLORS (same as dark for consistency) =====

  // Light Mode Backgrounds (using dark palette)
  static const Color lightBackgroundPrimary = Color(0xFF1a1621); // Darkest
  static const Color lightBackgroundSecondary = Color(0xFF2a2234); // Darker
  static const Color lightBackgroundTertiary = Color(0xFF3a3047); // Lightest

  // Light Mode Text
  static const Color lightTextPrimary = Color(0xFFFFFFFF); // White
  static const Color lightTextSecondary = Color(0x99FFFFFF); // White 60% opacity
  static const Color lightTextTertiary = Color(0x66FFFFFF); // White 40% opacity

  // Light Mode Borders (for glass effect)
  static const Color lightBorderPrimary = Color(0x33FFFFFF); // White 20% opacity
  static const Color lightBorderSecondary = Color(0x1AFFFFFF); // White 10% opacity
  ...
  // These map old color names to the new dark theme
  static const Color backgroundDeep = Color(0xFF1a1621); // Maps to darkest
  static const Color backgroundElevated = Color(0xFF3a3047); // Maps to lightest
  static const Color surfaceWhite = Color(0xFFFFFFFF); // Pure white
  static const Color textOnLight = Color(0xFFFFFFFF); // White text
