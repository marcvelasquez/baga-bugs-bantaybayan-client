...
class AuthService extends ChangeNotifier {
  ...
  void _initializeAppwrite() {
    if (!AppwriteConfig.isConfigured) {
      ...
      print('Please update lib/core/config/appwrite_config.dart with your project details.');
  ...
  Future<bool> register({
    ...
    try {
      ...
      if (e is AppwriteException && e.code == 401) {
        _showErrorToUser('Cannot connect to server. Please check your internet connection and try again.');
      } else {
        _showErrorToUser(e);
      }
      return false;
